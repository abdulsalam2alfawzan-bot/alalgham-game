...
بعد إنشاء الغرفة يتم توليد كودين منفصلين:

- `كود المشرف`: لإدارة غرفة المشرف فقط، وينتهي افتراضيًا بعد 12 ساعة.
- `كود اللاعب`: لانضمام اللاعبين فقط، وينتهي افتراضيًا بعد 6 ساعات.

كود التفعيل يستخدم قبل إنشاء الغرفة فقط. كود اللاعب لا يفتح غرفة المشرف، وكود المشرف لا يستخدم في صفحة دخول اللاعب.
...
- كود اللاعب وQR الدعوة مخصصان للاعبين فقط.
- كود المشرف خاص بالمشرف ولا يشارك مع اللاعبين.
